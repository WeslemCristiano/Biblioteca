...
public class TelaEmprestimo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Pesquisar por RA:");
        ...
        tblEmprestimos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id do Livro", "RA do Aluno", "Data de Devolução", "Nome do Livro", "Nome do Aluno"
            }
        ) {
    ...
    public void zerar() {
        ...
        for (Emprestimo emp : dao3.read()) {
            List<Aluno> lei = dao.readFor(emp.getLeitor_ra());
    ...
    public void comboBoxPopulate() {
        for (Aluno lei : dao.read()) {
            cmbLeitor.addItem(new Item("Nome: " + lei.getNome() + " || RA: " + Integer.toString(lei.getRg()) + " || E-mail: " + lei.getEmail(), Integer.toString(lei.getRg())));
        }
        for (Livros liv : dao2.select()) {
            cmbLivro.addItem(new Item("Título: " + liv.getNome() + " || Autor: " + liv.getAutor() + " || Ano: " + liv.getAno() + " || ID: " + Integer.toString(liv.getId()), Integer.toString(liv.getId())));
        }
    }
